...
const StartDialog = ({ totalAmount, close, start }: IProps) => (
  <>
    ...
    <Grid>
      ...
      <Text style={{ gridArea: 't1', alignSelf: 'center', fontSize: 24, color: COLORS.primary, fontWeight: 'bold' }}>
        {totalAmount + ' '}
        coupons found
      </Text>
      <Text style={{ gridArea: 't2' }}>We searched high and low to make sure you get the best coupons</Text>
